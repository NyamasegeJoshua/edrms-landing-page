 ...
 */ !(function (t, e) {
 ...
 - ${i}: ${e}`),
    ...
    i(
      ...
      function (t, e) {
        ...
        return class {
          ...
          resolveDTLFormat(t) {
            return n(t, !0) ? t : { main: (t = c(t))[0], from: t[1], to: t[2] };
          }
          getTimeTicks(t, e, i, o) {
            ...
            if (((o = d(o, 1)), s(e))) {
              c.set(
                "Milliseconds",
                m,
                x >= p.second ? 0 : y * Math.floor(c.get("Milliseconds", m) / y)
              ),
                x >= p.second &&
                  c.set(
                    "Seconds",
                    m,
                    x >= p.minute ? 0 : y * Math.floor(c.get("Seconds", m) / y)
                  ),
                x >= p.minute &&
                  c.set(
                    "Minutes",
              ...
              for (n = 1; u < i; )
                g.push(u),
                  x === p.year
                    ...
                    : h && (x === p.day || x === p.week)
                    ? (u = c.makeTime(a, t, r + n * y * (x === p.day ? 1 : 7)))
                    : h && x === p.hour && y > 1
        ...
        return {
          ...
          getDeferredAnimation: function (t, e, s) {
            ...
            r.forEach((t) => {
              ...
              (n =
                e && i(e.defer) ? o.defer : Math.max(n, s.duration + s.defer)),
            ...
            return t.split(";").reduce((t, e) => {
              ...
              return (
                s &&
                  i.length &&
                  (t[
                    s.replace(/-([a-z])/g, (t) => t[1].toUpperCase())
                  ] = i.join(":")),
                t
              );
            }, {});
    ...
    i(
      ...
      function (t, e, i, s) {
        ...
        return (
          ...
          (D.prototype.matrixSetter = D.prototype.rotationOriginXSetter = D.prototype.rotationOriginYSetter = D.prototype.rotationSetter = D.prototype.scaleXSetter = D.prototype.scaleYSetter = D.prototype.translateXSetter = D.prototype.translateYSetter = D.prototype.verticalAlignSetter = function (
            t,
            e
          ) {
    ...
    i(e, "Core/Renderer/RendererRegistry.js", [e["Core/Globals.js"]], function (
      t
    ) {
      var e, i;
      let s;
    ...
    i(e, "Core/Renderer/SVG/Symbols.js", [e["Core/Utilities.js"]], function (
      t
    ) {
      ...
      function (t, e, i, s, o, r, n, a, h) {
        ...
        class j {
          ...
          circle(t, e, i) {
            ...
            return (
              (o.xSetter = o.ySetter = function (t, e, i) {
        ...
        class u extends e {
          ...
          htmlUpdateTransform() {
            ...
            let t = this.renderer,
              ...
              d = this.styles,
              p = d && d.whiteSpace;
            if ((a(e, { marginLeft: i, marginTop: s }), "SPAN" === e.tagName)) {
              let i = this.rotation,
        ...
        class R {
          ...
          init(t, e, i = this.coll) {
            ...
            (this.userOptions = e),
              ...
              (this.categories = o.categories || (this.hasNames ? [] : void 0)),
          ...
          setTickInterval(t) {
            ...
            if (
              ...
              this.range &&
                m(this.max) &&
                ((this.userMin = this.min = v = Math.max(
                  this.dataMin,
                  this.minFromRange()
                )),
              ...
              void 0 === this.max
                ...
                : (this.tickInterval = O(
                    ...
                    this.tickAmount
                      ...
                      : void 0,
                    a ? 1 : ((this.max - this.min) * n) / Math.max(this.len, n)
                  )),
              o && !t)
            ) {
              let t =
          ...
          setExtremes(t, e, i, s, o) {
            ...
            (i = O(i, !0)),
              ...
              k(r, "setExtremes", (o = v(o, { min: t, max: e })), function () {
                (r.userMin = t),
                  (r.userMax = e),
                  (r.eventArgs = o),
                  i && n.redraw(s);
            ...
            if (
              ...
              p &&
                ...
                v &&
                  !g &&
                  !1 !== p.reserveSpace &&
                  ((t.titleOffset = S = t.axisTitle.getBBox()[
                    i ? "height" : "width"
                  ]),
          ...
          destroy(t) {
            ...
            e.plotLinesAndBandsGroups))
              e.plotLinesAndBandsGroups[t] = e.plotLinesAndBandsGroups[
                t
              ].destroy();
            L(e, function (t, i) {
    ...
    i(e, "Core/Axis/LogarithmicAxis.js", [e["Core/Utilities.js"]], function (
      t
    ) {
      var e;
          ...
          class h {
            ...
            getLogTickPositions(t, e, i, r) {
              ...
              if ((r || (this.minorAutoInterval = void 0), t >= 0.5))
                (t = Math.round(t)), (l = n.getLinearTickPositions(t, e, i));
              else if (t >= 0.08) {
                let s, o, n, a, h, d, c;
                let p = Math.floor(e);
                for (
                ...
                (t = s(
                  (t = o(u, this.minorAutoInterval, ((c - d) * g) / (f || 1)))
                )),
          ...
          render() {
            ...
            if (
              ...
              (S = e.plotLinesAndBandsGroups[A]) ||
                (e.plotLinesAndBandsGroups[A] = S = g
                  .g("plot-" + A)
                  .attr(u)
                  .add()),
        ...
        class S {
          ...
          destroy() {
            this.label && (this.label = this.label.destroy()),
              ...
              this.renderer &&
                ((this.renderer = this.renderer.destroy()), p(this.container)),
                ...
                return [r, n ? l : d, n ? t : e].concat(
                  a
                    ...
                    : [
                        ...
                        n ? s.plotLeft + s.plotWidth : s.plotTop + s.plotHeight,
                      ]
                );
              },
              f = g("y"),
          ...
          refresh(t, e) {
            ...
            let M = x(d) ? r(d, m, i) : c.call(m, this),
              C = h.series;
            if (((this.distance = b(C.tooltipOptions.distance, 16)), !1 === M))
              this.hide();
            else {
              if (this.split && this.allowShared) this.renderSplit(M, a);
                ...
                if (
                  ...
                  i.polar ||
                    !1 === C.options.clip ||
                    a.some(
                      (e) => n.isDirectTouch || e.series.shouldShowTooltip(t, o)
                    ))
                ) {
                  let t = this.getLabel();
                  (!s.style.width || u) &&
                ...
                let { anchorX: f, anchorY: m } = (function (t) {
                  ...
                  if (s) (e = Math.max(c + o, c)), (i = p + l / 2);
                    ...
                    (e = t.pos + d(o, -S, t.len + S)),
                      n.shouldShowTooltip(0, s.pos - p + r, { ignoreX: !0 }) &&
                        (i = s.pos + r);
                  }
                  return {
          ...
          updatePosition(t) {
            let {
              ...
              h = e.pointer,
              { left: l, top: d, scaleX: p, scaleY: u } = h.getChartPosition(),
            ...
            r &&
              ...
              r.setSize(a + x, n + x, !1),
              (1 !== p || 1 !== u) &&
                (c(i, { transform: `scale(${p}, ${u})` }), (f *= p), (m *= u)),
              (f += l - g.x),
              (m += d - g.y)),
              ...
              e &&
                ...
                y &&
                  (S
                    ...
                    : M &&
                      ((s.stateMarkerGraphic = S = g.renderer
        ...
        class b {
          ...
          drop(t) {
            ...
            if (this.selectionMarker) {
              let { x: o, y: r, width: n, height: a } = this.getSelectionBox(
    ...
    i(
      ...
      function (t, e, i, s, o, r) {
        ...
        class C {
          ...
          setOptions(t) {
            ...
            (this.options = t),
              this.chart.styledMode ||
                ...
                (this.itemHiddenStyle = b(this.itemStyle, t.itemHiddenStyle))),
          ...
          colorizeItem(t, e) {
            let { group: i, label: s, line: o, symbol: r } = t.legendItem || {};
            if (
              (i &&
          ...
          proximatePositions() {
            ...
            for (let o of (this.allItems.forEach(function (t) {
              ...
              t.yAxis &&
                ...
                t.points &&
                  (o = m(n ? t.points : t.points.slice(0).reverse(), function (
                    t
                  ) {
                    return y(t.plotY);
                  })),
          ...
          handleOverflow(t) {
            ...
            return (
              ...
              t && b > 0 && t > b && !1 !== l.enabled
                ? ((this.clipHeight = m = Math.max(
                    b - 20 - this.titleHeight - a,
                    0
                  )),
          ...
          if (
            (this.chart.styledMode ||
              ...
              n.dashStyle
                ...
                : "square" === n.linecap || (g["stroke-linecap"] = "round")),
            (i.line = c.path().addClass("highcharts-graph").attr(g).add(p)),
            g["stroke-linecap"] && (x = Math.min(i.line.strokeWidth(), a) / 2),
            a &&
              i.line.attr({
                d: [
                  ["M", x, u],
        ...
        class X {
          ...
          getExtremes(t, e) {
            ...
            for (
              ...
              if (
                ((c = o[u]),
                (l =
                  (B((p = t[u])) || I(p)) && ((B(p) ? p > 0 : p.length) || !a)),
                (d =
                  e ||
              ...
              (u = i.translate(y, !1, !1, !1, !0, h)),
                ...
                e &&
                  ...
                  b &&
                    ...
                    ((C = v[0]),
                    (k = v[1]),
                    C === c && f.key === w[y].base && (C = N(B(d) ? d : r.min)),
                ...
                (a.yBottom = M(C) ? x(r.translate(C, !1, !0, !1, !0)) : void 0),
                this.dataModify && (k = this.dataModify.modifyValue(k, p)),
                B(k) &&
                  void 0 !== a.plotX &&
                  (t = B((t = r.translate(k, !1, !0, !1, !0))) ? x(t) : void 0),
                (a.plotY = t),
          ...
          drawTracker() {
            ...
            h
              ...
              : t.graph &&
                ...
                [t.tracker, t.markerGroup, t.dataLabelsGroup].forEach(function (
                  t
                ) {
                  t &&
                    (t
          ...
          setVisible(t, e) {
            let i = this,
              ...
              r = i.visible;
            i.visible = t = i.options.visible = i.userOptions.visible =
              void 0 === t ? !r : t;
            let n = t ? "show" : "hide";
            [
              "group",
          ...
          select(t) {
            (this.selected = t = this.options.selected =
        ...
        class J {
          ...
          setSize(t, e, i) {
            ...
            (s.oldChartHeight = s.chartHeight),
              ...
              s.styledMode ||
                (r ? u : L)(
                  s.container,
                  { width: s.chartWidth + "px", height: s.chartHeight + "px" },
                  r
                ),
              s.setChartSize(!0),
          ...
          setChartSize(t) {
            ...
            (this.plotLeft = e = Math.round(this.plotLeft)),
              ...
              (this.plotWidth = s = Math.max(
                0,
                Math.round(a - e - this.marginRight)
              )),
              (this.plotHeight = o = Math.max(
                0,
                Math.round(h - i - this.marginBottom)
              )),
          ...
          update(t, e, i, s) {
            ...
            let u = p && p.width,
              g =
                p && (X(p.height) ? q(p.height, u || a.chartWidth) : p.height);
    ...
    i(
      ...
      function (t, e, i, s, o, r) {
        let { stop: n } = t,
          { addEvent: a, createElement: h, defined: l, merge: d, pick: c } = r;
        a(i, "afterSetChartSize", function (t) {
          ...
          this.renderer.forExport ||
            (s
              ? ((this.scrollablePixelsX = r = Math.max(
                  0,
                  s - this.chartWidth
                )),
                r &&
                  ((this.scrollablePlotBox = this.renderer.scrollablePlotBox = d(
                    this.plotBox
                  )),
              ...
              : o &&
                ((this.scrollablePixelsY = n = Math.max(
                  0,
                  o - this.chartHeight
                )),
                l(n) &&
        ...
        function C(t, e) {
          ...
          for (P.stacksTouched += 1, c = 0; c < v; c++) {
            (p = x[c]),
              ...
              (r = L[a][p]),
              null !== g
                ? ((r.points[h] = r.points[this.index] = [m(r.cumulative, M)]),
                  d(r.cumulative) || (r.base = h),
                  (r.touched = P.stacksTouched),
                  i.index > 0 &&
                    !1 === this.singleStacks &&
                    (r.points[h][0] = r.points[this.index + "," + p + ",0"][0]))
      ...
      function (t, e, i) {
        ...
        class n extends t {
          ...
          drawGraph() {
            ...
            s || n[0].push(e.lineColor || this.color || "#cccccc", e.dashStyle),
        ...
        class l extends o {
          ...
          drawGraph() {
            ...
            s.forEach(function (e, s) {
              o.push([
                "zone-area-" + s,
                "highcharts-area highcharts-zone-area-" + s + " " + e.className,
                e.color || t.color,
          ...
          getGraphPath(t) {
            ...
            for (let o = 0, r = t.length; o < r; ++o)
              a ||
                (t[o].leftCliff = t[o].rightCliff = t[o].leftNull = t[
                  o
                ].rightNull = void 0),
                (i = t[o].isNull),
                ...
                ? ((e = t.shapeArgs),
                  ...
                  i.enabledDataSorting &&
                    (t.startXPos = i.xAxis.reversed
                      ...
                      : i.xAxis.width),
                  !h &&
                    ((t.graphic = h = r[t.shapeType](e).add(
                      t.group || i.group
                    )),
                    h &&
                      i.enabledDataSorting &&
                        ...
                        if (c) {
                          if (
                            ...
                            (k = n(v)
                              ? r(v, y, i)
                              : (
                                  h[t.formatPrefix + "Formatter"] || h.formatter
                                ).call(y, h)),
                            (S = h.rotation),
                            !i.styledMode &&
                              ((f.color = u(
        ...
        return (
          (function (e) {
            ...
            function a(t, e, i, s, a) {
              ...
              (i.align = n(i.align, !h || g ? "center" : u ? "right" : "left")),
                (i.verticalAlign = n(
                  i.verticalAlign,
    ...
    i(
      ...
      function (t, e, i, s, o) {
        ...
        let { noop: n } = e,
          { distribute: a } = i,
          { series: h } = s,
          { arrayMax: l, clamp: d, defined: c, pick: p, relativeLength: u } = o;
        return (
          (function (e) {
            let i = [],
              s = {
